      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-4">
            <div className="info-block text-white address shadow">
              Address
              <h5 className="pt-4">{accounts && accounts[0]}</h5>
            </div>
          </div>
          <div className="col-md-4">
            <div className="info-block text-white pch-balance shadow">
              Pouch Balance
              <h1 className="pt-3">
          ...
          <div className="col-md-4">
            <div className="info-block text-white dai-balance shadow">
              Dai Balance
              <h1 className="pt-3">
